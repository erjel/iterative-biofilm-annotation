...
def plot_accuracy_comparison(
    ...
    semimanual_accuracies: Optional[List[Path]] = None,
    ) -> None:
...
def parse_args() -> Namespace:
    ...
    parser.add_argument('--semimanual_accuracies', type=Path, nargs='+', default=[])
